...
namespace Cross.DataVault.UWP
{
    ...
    sealed partial class App
    {
        ...
        protected override void Configure()
        {
            ...
            //SQLiteConnection connection = new SQLiteConnection(new SQLitePlatformWinRT(), SqlitePath, false);
            //Database context = new Database(SqlitePath, connection);
