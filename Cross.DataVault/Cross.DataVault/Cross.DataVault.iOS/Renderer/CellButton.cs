...
//[assembly: ExportRenderer(typeof(Cross.DataVault.Controls.CellButton), typeof(Cross.DataVault.iOS.CellButton))]
namespace Cross.DataVault.iOS
{
    class CellButton : ButtonRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            RippleButton.RippleColor = new UIColor(0.7f, 1.0f);
